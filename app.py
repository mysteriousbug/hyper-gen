...
# Left column - Source (now with translate button)
with col1:
    ...
    if uploaded_file is not None:
        ...
        # Translate button now in source column
...
# Right column - Target (now just shows results)
with col2:
    ...
    if st.session_state.translated_file:
        ...
        st.info("Translation will appear here after you upload a file and click Translate")
